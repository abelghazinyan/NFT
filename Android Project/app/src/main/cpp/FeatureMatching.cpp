...
bool FeatureMatching::track(bool& markerFound, vector<Point2f> &matchedCorners, vector<Point2f>& trackedCorners, vector<Point2f>& tracks, int& tracksCount, Mat& frameGray, Mat maskBounding)
{
