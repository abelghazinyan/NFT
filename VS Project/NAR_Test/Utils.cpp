...
void Utils::drawBoundingBox(Mat &view, std::vector<Point2f> &scene_corners, Scalar color)
{
	...
	line(view, scene_corners[0], scene_corners[1], color, 2, LINE_AA);
	line(view, scene_corners[1], scene_corners[2], color, 2, LINE_AA);
	line(view, scene_corners[2], scene_corners[3], color, 2, LINE_AA);
	line(view, scene_corners[3], scene_corners[0], color, 2, LINE_AA);

	circle(view, scene_corners[0], 3, color, -1, LINE_AA);
	circle(view, scene_corners[1], 3, color, -1, LINE_AA);
	circle(view, scene_corners[2], 3, color, -1, LINE_AA);
	circle(view, scene_corners[3], 3, color, -1, LINE_AA);
}
...
void Utils::drawCube(PNP &pnp, Mat &src, Mat &frame)
{
	...
	cv::line(frame, vectorStart[0], vectorEnd[0], color, 3, LINE_AA);
	cv::line(frame, vectorStart[1], vectorEnd[1], color, 3, LINE_AA);
	cv::line(frame, vectorStart[2], vectorEnd[2], color, 3, LINE_AA);
	cv::line(frame, vectorStart[3], vectorEnd[3], color, 3, LINE_AA);

	cv::line(frame, vectorEnd[0], vectorEnd[1], color, 3, LINE_AA);
	cv::line(frame, vectorEnd[1], vectorEnd[2], color, 3, LINE_AA);
	cv::line(frame, vectorEnd[2], vectorEnd[3], color, 3, LINE_AA);
	cv::line(frame, vectorEnd[3], vectorEnd[0], color, 3, LINE_AA);

	cv::line(frame, vectorStart[0], vectorStart[1], color, 3, LINE_AA);
	cv::line(frame, vectorStart[1], vectorStart[2], color, 3, LINE_AA);
	cv::line(frame, vectorStart[2], vectorStart[3], color, 3, LINE_AA);
	cv::line(frame, vectorStart[3], vectorStart[0], color, 3, LINE_AA);
}